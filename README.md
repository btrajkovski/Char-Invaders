...
Преку `Settings` менито се подесува дали да е вклучен или исклучен звукот во играта, како и музиката во главното мени, исто така постои и можност да се смени темата со што се менува изгледот на главното и изгледот на играта. 

Во делот `How To Play` е дадено кратко упатство на англиски јазик за тоа како се игра играта и во делот `Credits` се сите кои учествувале во изработка на играта.
...
###SoundCollection
Во ова класа се сместени сите во играта и се користат преку ова класа
